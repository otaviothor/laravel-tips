...
<form class="form-signin" method="post" action="{{route('admin.login.do')}}">
    ...
    @if($errors->all())
        ...
        @endforeach
    @endif
    <input type="text" class="form-control" name="email" placeholder="Seu email" value="otavio@gmail.com">
    <input type="password" class="form-control" name="password" placeholder="Senha" value="12345678">

                ...
                <div class="container">
                    <div class="carousel-caption text-left">
                        @if(date('H') >= 4 && date('H') <= 12)
                            <h1 class="display-1">Bom dia! &middot; {{ date('h') . "h" . date('i') }}</h1>
                        @elseif(date('H') > 12 && date('H') <= 18)
                            <h1 class="display-1">Boa tarde! &middot; {{ date('h') . "h" . date('i') }}</h1>
                        @else
                            <h1 class="display-1">Boa noite! &middot; {{ date('h') . "h" . date('i') }}</h1>
                        @endif
                    </div>
                </div>
            </div>
